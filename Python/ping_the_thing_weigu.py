...
RECEIVER = 'weigu@vo.lu'

# add here your Ip addresses and a meaningfull name of the thing
WAIT_BETWEEN_CHECKS = 10 # in minutes

IP_DICT =  {'192.168.1.21':'fritz_stuff',
            '192.168.1.22':'fritz_kichen',
            '192.168.1.23':'fritz_keller',
            '192.168.1.24':'fritz_garage',
            '192.168.1.25':'fritz_gard',
            '192.168.1.30':'waermepompel',
            '192.168.1.33':'smartyreaderx5',
            '192.168.1.42':'instar_camera',
            '192.168.1.54':'nas',
            '192.168.1.60':'udoo_server',
            '192.168.1.63':'beagle_solar',
            '192.168.1.77':'neo_clock',
            '192.168.1.80':'feinstaub_gard',
            '192.168.1.81':'feinstaub_kautsch',
            '192.168.1.90':'snom_guy',
            '192.168.1.91':'snom_kichen',
            '192.168.1.92':'snom_pier',
            '192.168.1.93':'snom_elektro',
            '192.168.1.94':'clever',
            '192.168.1.99':'piventi',
            #'192.168.1.200':'pihole',
            '192.168.1.203':'raspi_sdr',
            '192.168.1.230':'lorawan_gateway',
            '192.168.1.231':'test5',
            '192.168.1.232':'test4',
            '192.168.1.233':'test6',
            '85.93.205.148 ':'tux.lu',
          }
...
def main():
    ...
    while True:
        ...
        if dt.time(18,40,0) <= now_time <= dt.time(18,40,5):
            mail_flag_list = create_mail_flag_list()
            sleep(5)
